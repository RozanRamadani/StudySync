    ...
    <div className="page-wrapper min-h-[calc(100vh_-_72px)] flex flex-col items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-2xl sm:text-3xl mb-2 font-serif font-bold text-text-primary">Selamat Datang Kembali</h1>
          <p className="text-sm text-text-secondary">Masuk untuk melihat analitik belajar AI Anda.</p>
        </div>
        ...
        <p className="text-center mt-6 text-sm text-text-secondary">
          Belum punya akun?{" "}
          <Link href="/register" className="text-accent-blue font-semibold no-underline hover:underline">
            Daftar
          </Link>
        </p>
      </motion.div>
